...
function About() {
  return (
    <>
      {(document.title = "About Us - Newsify")}
      <div className="container" style={{ padding: "5rem" }}>
        <div className="row">
          ...
          <div className="col-8">
            ...
            <p>
              Welcome to our Newsify app! We are a team of dedicated journalists
            ...
            <p>
              Our news app is designed to bring you the latest and most accurate
              news as soon as it hits the market. Whether you're interested in
              national and international news, politics, sports, business, or
              entertainment, we've got you covered.
            </p>
            <p>
              Our app features a wide range of categories to choose from, so you
              can easily find the stories that matter most to you. Plus, our app
              is designed to be fast, reliable, and easy to use, so you can stay
              informed on the go. So why wait? Install our app today and stay
